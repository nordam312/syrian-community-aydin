...
const About = () => {
  ...
  const content = {
    ar: {
      heroTitle: "من نحن",
      heroSubtitle: "مجتمع متماسك من الطلاب السوريين المتطوعين لتسهيل أمور زملائهم في جامعة اسطنبول آيدن، وتمثيلهم في المحافل ذات الصلة",
      aboutTitle: "من نحن",
      aboutContent1: " اتحاد الطلاب هو الممثل الرسمي والوحيد لجميع الطلاب السوريين في جامعة اسطنبول آيدن، وجزء لا يتجزأ من الاتحاد العام لطلبة سوريا المعترف به في داخل وخارج تركيا.",
      ...
      goalsContent: "نسعى إلى بناء مجتمع طلابي سوري متماسك في أيدن، يدعم أفراده بعضهم البعض ويسهم في تقديم صورة إيجابية عن بلدنا سوريا.",
      ...
      feature1Desc: "نعمل على توحيد الجالية الطلابية السورية في جامعة أيدن",
