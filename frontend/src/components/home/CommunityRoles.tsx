...
const roles = [
	...
	},
	{
		...
		description:
			'Maintaining our digital infrastructure and technical projects',
			...
			<div className="page-container">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
					{roles.map((role, index) => (
						<Card
							key={index}
							className="border border-syria-green-100 shadow-sm hover:shadow-md transition-shadow"
						>
							<CardContent className="pt-6 flex flex-col items-center text-center">
								<div className="mb-4">{role.icon}</div>
								<h3 className="font-bold text-lg mb-2 text-syria-green-700">
									{role.title}
								</h3>
